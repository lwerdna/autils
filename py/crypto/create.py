...
g_fname = 'test.txt'
g_date = '\x59\x4c\xfb\x34'
g_message = 'hi there\x0a'
g_salt = '\x99\xc1\x94\xfc\x83\xc0\xad\xdf'
g_passphrase = 'pw'
...
def create_pkt9(ptext, passphrase, salt):
	...
	prefix = '\x6e\xf4\x0c\xa7\x22\xd7\x74\xd6'
...
if __name__ == '__main__':
	...
	pkt9 = create_pkt9(pkt11, g_passphrase, g_salt)
	print 'pkt9: ', pkt9.encode('hex')

	pkt3 = create_pkt3(g_salt)
