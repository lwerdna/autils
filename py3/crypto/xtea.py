...
def xtea_encrypt_ofb(plaintext, key, iv=b"\x41\x42\x43\x44\x45\x46\x47\x48"):
    ...
    for i in range(length):
        ciphertext += bytes([plaintext[i] ^ stream[i]])
...
if __name__ == '__main__':
    ...
    input = b"\x49\x7d\xf3\xd0\x72\x61\x2c\xb5And in front of my desk I see a little blue pencil and a whiteboard, what do I write?"
